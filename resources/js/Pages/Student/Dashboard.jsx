                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white/10 backdrop-blur-lg border border-white/20 overflow-hidden shadow-xl sm:rounded-2xl p-8 text-white">
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <Link href="/student/apply" className="bg-indigo-500 hover:bg-indigo-600 transition-colors px-6 py-2 rounded-full font-medium shadow-lg shadow-indigo-500/30">
                                + New Application
                            </Link>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors duration-300">
                                ...
                                <div className="text-sm text-slate-300 uppercase tracking-wider font-semibold">Documents Verified</div>
                            </div>
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors duration-300">
